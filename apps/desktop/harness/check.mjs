...
const CASES = [
  ...
  // A stopped operation: the conflicts dashboard (shared with the extensions)
  // in place of the old banner, and the shared merge editor.
  ["the-dashboard-ends-an-operation-with-its-own-verb", "changes", { extra: "op=merge" }],
  ["the-dashboard-ends-an-operation-with-its-own-verb", "changes", { extra: "op=rebase" }],
  ["the-dashboard-ends-an-operation-with-its-own-verb", "changes", { extra: "op=cherry-pick" }],
  ["the-dashboard-ends-an-operation-with-its-own-verb", "changes", { extra: "op=revert" }],
  ["the-dashboard-ends-an-operation-with-its-own-verb", "changes", { extra: "op=am" }],
  ["a-dashboard-verb-cannot-be-fired-twice", "changes", { extra: "op=merge" }],
  ["skip-only-where-git-allows", "changes", { extra: "op=merge", arg: "no" }],
  ["skip-only-where-git-allows", "changes", { extra: "op=rebase&conflicts=1", arg: "no" }],
  ["skip-only-where-git-allows", "changes", { extra: "op=rebase&apply=1&skip=1", arg: "yes" }],
  ["skip-only-where-git-allows", "changes", { extra: "op=cherry-pick", arg: "yes" }],
  ["skip-only-where-git-allows", "changes", { extra: "op=am&skip=1", arg: "yes" }],
  ["continue-disabled-says-why", "changes", { extra: "op=rebase&conflicts=2" }],
  ["dashboard-names-rebase-direction", "changes", { extra: "opctx=reporter" }],
  ["dashboard-names-rebase-direction", "changes", { extra: "opctx=reporter", theme: "light" }],
  ["the-reporters-rebase-resolves-the-right-way-round", "changes", { extra: "opctx=reporter" }],
  ["the-dashboard-resets-for-each-rebase-step", "changes", { extra: "opctx=three" }],
  ["an-emptied-commit-is-not-dropped-silently", "changes", { extra: "opctx=reporter&willdrop=1" }],
  ["merge-shell-has-toolbar-on-desktop", "changes", { extra: "opctx=merge" }],
  ...
  // The editor on the Repositories row, and what has changed per repository (#32).
  ["with-no-editor-a-repository-row-has-no-empty-control", "repositories", { extra: "noeditors=1" }],
  ["the-github-side-opens-your-copy-in-an-editor", "repositories~click:.gh-seg-btn:nth-child(2)"],
  ["repository-rows-say-what-has-changed", "repositories"],
  ["counts-arrive-without-moving-the-row", "repositories", { extra: "nested=1&slow=repos:localStatus:1500" }],
  ["change-counts-come-in-batches-of-sixteen", "repositories", { extra: "nested=1" }],
  ["a-folded-folder-is-asked-about-when-it-opens", "repositories", { extra: "nested=1" }],
  ["a-stale-count-batch-writes-nothing", "repositories", { extra: "nested=1&statusdelays=2500" }],
  ["a-long-repository-name-keeps-its-counts-and-controls", "repositories", { extra: "longrepo=1", width: 1000 }],
  ...
  ["a-branch-that-already-matches-asks-nothing", "branches", { extra: "resetbranches=1" }],
  ["a-branch-only-behind-its-upstream-loses-nothing", "branches", { extra: "resetbranches=1" }],
  ["a-reset-question-does-not-follow-you-to-another-repository", "branches"],
