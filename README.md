...
| **Linux** | `GitStudio-<version>-x86_64.AppImage` (universal) · `GitStudio-<version>-amd64.deb` (Debian/Ubuntu) · `GitStudio-<version>-x86_64.rpm` (Fedora/RHEL) · `GitStudio-<version>-x64.tar.gz` (portable) |
